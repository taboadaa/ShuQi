...
/**@brief Function for encoding All Readed.
 *
 * @param[in]   p_all_readed              All Readed structure to be encoded.
 * @param[out]  p_encoded_buffer   Buffer where the encoded data will be written.
 *
 * @return      Size of encoded data.
 */
...
/**@brief Function for decoding All Readed.
 *
 * @param[in]   data_len              Length of the field to be decoded.
 * @param[in]   p_data                Buffer where the encoded data is stored.
 * @param[out]  p_write_val           Decoded data.
...
uint32_t ble_stuff_list_init(ble_stuff_list_t * p_stuff_list,
	...
	ble_stuff_list_stuff_readed_t stuff_readed_initial_value =
			p_stuff_list_init->ble_stuff_list_stuff_readed_initial_value;
	...
	ble_stuff_list_stuff_number_t stuff_number_initial_value =
			p_stuff_list_init->ble_stuff_list_stuff_number_initial_value;
