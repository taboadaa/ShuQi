...
uint32_t bluetooth_init(void)
{
    ...
    memset(&stuff_list_init.ble_stuff_list_stuff_entry_initial_value.entry_number,
           0x00,
           sizeof(stuff_list_init.ble_stuff_list_stuff_entry_initial_value.entry_number));
    memset(&stuff_list_init.ble_stuff_list_stuff_readed_initial_value.all_readed,
           0x00,
           sizeof(stuff_list_init.ble_stuff_list_stuff_readed_initial_value.all_readed));
    memset(&stuff_list_init.ble_stuff_list_stuff_number_initial_value.entry_number,
           0x00,
